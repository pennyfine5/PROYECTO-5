...
st.subheader("💰 Comparación de ingresos por plan")

data_plot = df_period if period == "Anual" else df_filtered
...
# CONCLUSIONES
# =========================
st.markdown("### 📊 Rentabilidad por usuario")

col1, col2 = st.columns(2)

col1.markdown(f"""
**Plan Surf**
- Número de usuarios: **{surf_users}**
- Ingreso promedio anual por usuario: **${surf_avg:,.2f}**
""")

col2.markdown(f"""
**Plan Ultimate**
- Número de usuarios: **{ultimate_users}**
- Ingreso promedio anual por usuario: **${ultimate_avg:,.2f}**
""")

st.success(
    f"👉 Ultimate genera **${diff:,.2f} más por usuario al año** que Surf"
)
